      ...
      <section className="relative py-8 sm:p-8">
        <div className="w-full max-w-8xl mx-auto px-4 lg:px-8 xl:px-14">
          <div className="flex items-center justify-between gap-3 mb-5">
            ...
            <div>
              <button
                className="bg-orange-100 text-orange-600 rounded-md px-8 py-1.5"
          ...
          <div className="border border-gray-200">
            ...
            <div className="grid grid-cols-7 divide-gray-200">
              {days.map((day, index) => (
                <div
                  key={index}
                  className={`p-3.5 border-b border-r border-gray-200 xl:aspect-auto flex justify-between flex-col max-lg:items-center min-h-32 transition-all duration-300 hover:bg-gray-100 ${
                    day === null ? "bg-gray-50" : ""
                  }`}
                >
                  {day && (
